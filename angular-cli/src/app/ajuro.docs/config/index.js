...
module.exports = new DgeniPackage('cma-docs', [
...
.config(function(templateFinder) {
    ...
    templateFinder.templateFolders.unshift(path.resolve(packagePath, 'ajuro.docs/config/templates'));
})

.config(function(computePathsProcessor, computeIdsProcessor) {

  // , 'indexPage' in doctype
