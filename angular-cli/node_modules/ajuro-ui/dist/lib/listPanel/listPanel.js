...
var ListPanel = (function (_super) {
  ...
  ListPanel.prototype.agWire = function (loggerFactory) {
        this.logger = loggerFactory.create('ListPanel');
  ...
  ListPanel.prototype.getVerticalPixelRange = function () {
  ...
  ListPanel.prototype.onRowDataChanged = function () {
        this.showOrHideOverlay();
    };
  ListPanel.prototype.showOrHideOverlay = function () {
  ...
  ListPanel.prototype.getLayout = function () {
        return this.layout;
    };
  ...
  ListPanel.prototype.addStopEditingWhenGridLosesFocus = function () {
        var _this = this;
  ...
  ListPanel.prototype.addAngularApplyCheck = function () {
        var _this = this;
  ...
  ListPanel.prototype.disableBrowserDragging = function () {
  ...
  ListPanel.prototype.addEventListeners = function () {
  ...
  ListPanel.prototype.addDragListeners = function () {
        var _this = this;
  ...
  ListPanel.prototype.addMouseEvents = function () {
        var _this = this;
  ...
  ListPanel.prototype.addKeyboardEvents = function () {
        var _this = this;
  ...
  ListPanel.prototype.addBodyViewportListener = function () {
        var _this = this;
  ...
  ListPanel.prototype.getRowForEvent = function (event) {
  ...
  ListPanel.prototype.processKeyboardEvent = function (eventName, keyboardEvent) {
  ...
  ListPanel.prototype.handlePageScrollingKey = function (pagingKeyGroup, pagingKey, keyboardEvent) {
  ...
  ListPanel.prototype.pageHorizontally = function (pagingKey) {
        //***************************************************************************
        //column to select
    ...
    //Either HOME OR END
    ListPanel.prototype.pageDiagonally = function (pagingKey) {
        //***************************************************************************
    ...
    ListPanel.prototype.pageVertically = function (pagingKey) {
    ...
    // to the top
    ListPanel.prototype.scrollToTop = function () {
        if (!this.forPrint) {
            this.getPrimaryScrollViewport().scrollTop = 0;
        }
    };
    //Performs any scroll
    ListPanel.prototype.performScroll = function (scroll) {
        var verticalScroll;
        var diagonalScroll;
        var horizontalScroll;
    ...
    ListPanel.prototype.processMouseEvent = function (eventName, mouseEvent) {
    ...
    ListPanel.prototype.onContextMenu = function (mouseEvent) {
    ...
    ListPanel.prototype.preventDefaultOnContextMenu = function (mouseEvent) {
    ...
    ListPanel.prototype.addShortcutKeyListeners = function () {
        var _this = this;
    ...
    ListPanel.prototype.onCtrlAndA = function (event) {
    ...
    ListPanel.prototype.onCtrlAndC = function (event) {
    ...
    ListPanel.prototype.onCtrlAndV = function (event) {
    ...
    ListPanel.prototype.onCtrlAndD = function (event) {
        if (!this.clipboardService) {
            return;
        }
    ...
    ListPanel.prototype.createOverlayTemplate = function (name, defaultTemplate, userProvidedTemplate) {
    ...
    ListPanel.prototype.createLoadingOverlayTemplate = function () {
    ...
    ListPanel.prototype.createNoRowsOverlayTemplate = function () {
    ...
    ListPanel.prototype.ensureIndexVisible = function (index) {
    ...
    ListPanel.prototype.getPrimaryScrollViewport = function () {
    ...
    ListPanel.prototype.getCenterWidth = function () {
        return this.eBodyViewport.clientWidth;
    };
    ListPanel.prototype.isHorizontalScrollShowing = function () {
        var result = utils_1.Utils.isHorizontalScrollShowing(this.eBodyViewport);
        return result;
    };
    ListPanel.prototype.isVerticalScrollShowing = function () {
    ...
    ListPanel.prototype.isBodyVerticalScrollShowing = function () {
    ...
    ListPanel.prototype.periodicallyCheck = function () {
        if (this.forPrint) {
            return;
        }
    ...
    ListPanel.prototype.setScrollShowing = function () {
        var params = {
            vBody: false,
            hBody: false,
            vPinnedLeft: false,
    ...
    ListPanel.prototype.setBottomPaddingOnPinnedRight = function () {
        if (this.forPrint) {
            return;
        }
        if (this.columnController.isPinningRight()) {
    ...
    ListPanel.prototype.setMarginOnFullWidthCellContainer = function () {
        if (this.forPrint) {
            return;
        }
    ...
    ListPanel.prototype.ensureColumnVisible = function (key) {
        // if for print, everything is always visible
        if (this.gridOptionsWrapper.isForPrint()) {
            return;
        }
    ...
    ListPanel.prototype.showLoadingOverlay = function () {
        if (!this.gridOptionsWrapper.isSuppressLoadingOverlay()) {
            this.layout.showOverlay('loading');
        }
    };
    ListPanel.prototype.showNoRowsOverlay = function () {
        if (!this.gridOptionsWrapper.isSuppressNoRowsOverlay()) {
            this.layout.showOverlay('noRows');
        }
    };
    ListPanel.prototype.hideOverlay = function () {
        this.layout.hideOverlay();
    };
    ListPanel.prototype.getWidthForSizeColsToFit = function () {
    ...
    ListPanel.prototype.sizeColumnsToFit = function (nextTimeout) {
        var _this = this;
    ...
    ListPanel.prototype.getBodyContainer = function () {
        return this.eBodyContainer;
    };
    ListPanel.prototype.getDropTargetBodyContainers = function () {
        if (this.forPrint) {
    ...
    ListPanel.prototype.getBodyViewport = function () {
        return this.eBodyViewport;
    };
    ListPanel.prototype.getDropTargetLeftContainers = function () {
        if (this.forPrint) {
            return [];
        }
        else {
    ...
    ListPanel.prototype.getDropTargetPinnedRightContainers = function () {
        if (this.forPrint) {
            return [];
        }
        else {
    ...
    ListPanel.prototype.getHeaderContainer = function () {
        return this.eHeaderContainer;
    };
    ListPanel.prototype.getHeaderOverlay = function () {
        return this.eHeaderOverlay;
    };
    ListPanel.prototype.getRoot = function () {
        return this.eRoot;
    };
    ListPanel.prototype.getPinnedLeftHeader = function () {
        return this.ePinnedLeftHeader;
    };
    ListPanel.prototype.getPinnedRightHeader = function () {
        return this.ePinnedRightHeader;
    };
    ListPanel.prototype.queryHtmlElement = function (selector) {
        return this.eRoot.querySelector(selector);
    };
    ListPanel.prototype.loadTemplate = function () {
    ...
    ListPanel.prototype.findElements = function () {
        var _this = this;
        if (this.forPrint) {
    ...
    ListPanel.prototype.getRowContainers = function () {
        return this.rowContainerComponents;
    };
    ListPanel.prototype.addMouseWheelEventListeners = function () {
    ...
    ListPanel.prototype.getHeaderViewport = function () {
        return this.eHeaderViewport;
    };
    ListPanel.prototype.centerMouseWheelListener = function (event) {
    ...
    ListPanel.prototype.genericMouseWheelListener = function (event) {
        var targetPanel;
    ...
    ListPanel.prototype.generalMouseWheelListener = function (event, targetPanel) {
    ...
    ListPanel.prototype.onDisplayedColumnsChanged = function () {
        this.setPinnedContainersVisible();
        this.setBodyAndHeaderHeights();
        this.setLeftAndRightBounds();
    };
    ListPanel.prototype.onDisplayedColumnsWidthChanged = function () {
    ...
    ListPanel.prototype.onScrollVisibilityChanged = function () {
        this.setWidthsOfContainers();
    };
    ListPanel.prototype.setWidthsOfContainers = function () {
    ...
    ListPanel.prototype.setPinnedLeftWidth = function () {
    ...
    ListPanel.prototype.setPinnedRightWidth = function () {
    ...
    ListPanel.prototype.setPinnedContainersVisible = function () {
    ...
    ListPanel.prototype.setBodyAndHeaderHeights = function () {
        if (this.forPrint) {
    ...
    ListPanel.prototype.getBodyHeight = function () {
        return this.bodyHeight;
    };
    ListPanel.prototype.setHorizontalScrollPosition = function (hScrollPosition) {
        this.eBodyViewport.scrollLeft = hScrollPosition;
    };
    // tries to scroll by pixels, but returns what the result actually was
    ListPanel.prototype.scrollHorizontally = function (pixels) {
    ...
    ListPanel.prototype.addScrollListener = function () {
        var _this = this;
    ...
    ListPanel.prototype.onBodyScroll = function () {
        this.onBodyHorizontalScroll();
        this.onBodyVerticalScroll();
    };
    ListPanel.prototype.onBodyHorizontalScroll = function () {
    ...
    ListPanel.prototype.onBodyVerticalScroll = function () {
        var bodyVScrollActive = this.isBodyVerticalScrollActive();
        if (bodyVScrollActive) {
            this.onVerticalScroll(this.eBodyViewport);
        }
    };
    ListPanel.prototype.onVerticalScroll = function (sourceElement) {
    ...
    ListPanel.prototype.isBodyVerticalScrollActive = function () {
    ...
    ListPanel.prototype.addIEPinFix = function (onPinnedRightScroll, onPinnedLeftScroll) {
        var _this = this;
        var listener = function () {
    ...
    ListPanel.prototype.setLeftAndRightBounds = function () {
        if (this.gridOptionsWrapper.isForPrint()) {
            return;
        }
    ...
    ListPanel.prototype.isUseScrollLag = function () {
    ...
    ListPanel.prototype.debounce = function (callback) {
        var _this = this;
    ...
    ListPanel.prototype.getBodyViewportScrollLeft = function () {
        if (this.forPrint) {
            return 0;
        }
    ...
    ListPanel.prototype.setBodyViewportScrollLeft = function (value) {
        if (this.forPrint) {
            return;
        }
        // we defer to a util, as how you calculated scrollLeft when doing RTL depends on the browser
    ...
    ListPanel.prototype.horizontallyScrollHeaderCenterAndFloatingCenter = function () {
    ...
    ListPanel.prototype.fakeVerticalScroll = function (position) {
        if (this.enableRtl) {
            // RTL
    ...
    ListPanel.prototype.addScrollEventListener = function (listener) {
        this.eBodyViewport.addEventListener('scroll', listener);
    };
    ListPanel.prototype.removeScrollEventListener = function (listener) {
        this.eBodyViewport.removeEventListener('scroll', listener);
    };
    __decorate([
        context_1.Autowired('alignedGridsService'),
        __metadata("design:type", alignedGridsService_1.AlignedGridsService)
    ], ListPanel.prototype, "alignedGridsService", void 0);
    __decorate([
        context_1.Autowired('gridOptionsWrapper'),
        __metadata("design:type", gridOptionsWrapper_1.GridOptionsWrapper)
    ], ListPanel.prototype, "gridOptionsWrapper", void 0);
    __decorate([
        context_1.Autowired('columnController'),
        __metadata("design:type", columnController_1.ColumnController)
    ], ListPanel.prototype, "columnController", void 0);
    __decorate([
        context_1.Autowired('rowRenderer'),
        __metadata("design:type", rowRenderer_1.RowRenderer)
    ], ListPanel.prototype, "rowRenderer", void 0);
    __decorate([
        context_1.Autowired('pinnedRowModel'),
        __metadata("design:type", pinnedRowModel_1.PinnedRowModel)
    ], ListPanel.prototype, "pinnedRowModel", void 0);
    __decorate([
        context_1.Autowired('eventService'),
        __metadata("design:type", eventService_1.EventService)
    ], ListPanel.prototype, "eventService", void 0);
    __decorate([
        context_1.Autowired('context'),
        __metadata("design:type", context_1.Context)
    ], ListPanel.prototype, "context", void 0);
    __decorate([
        context_1.Autowired('paginationProxy'),
        __metadata("design:type", paginationProxy_1.PaginationProxy)
    ], ListPanel.prototype, "paginationProxy", void 0);
    __decorate([
        context_1.Optional('rangeController'),
        __metadata("design:type", Object)
    ], ListPanel.prototype, "rangeController", void 0);
    __decorate([
        context_1.Autowired('dragService'),
        __metadata("design:type", dragService_1.DragService)
    ], ListPanel.prototype, "dragService", void 0);
    __decorate([
        context_1.Autowired('selectionController'),
        __metadata("design:type", selectionController_1.SelectionController)
    ], ListPanel.prototype, "selectionController", void 0);
    __decorate([
        context_1.Optional('clipboardService'),
        __metadata("design:type", Object)
    ], ListPanel.prototype, "clipboardService", void 0);
    __decorate([
        context_1.Autowired('csvCreator'),
        __metadata("design:type", csvCreator_1.CsvCreator)
    ], ListPanel.prototype, "csvCreator", void 0);
    __decorate([
        context_1.Autowired('mouseEventService'),
        __metadata("design:type", mouseEventService_1.MouseEventService)
    ], ListPanel.prototype, "mouseEventService", void 0);
    __decorate([
        context_1.Autowired('focusedCellController'),
        __metadata("design:type", focusedCellController_1.FocusedCellController)
    ], ListPanel.prototype, "focusedCellController", void 0);
    __decorate([
        context_1.Autowired('$scope'),
        __metadata("design:type", Object)
    ], ListPanel.prototype, "$scope", void 0);
    __decorate([
        context_1.Autowired('scrollVisibleService'),
        __metadata("design:type", scrollVisibleService_1.ScrollVisibleService)
    ], ListPanel.prototype, "scrollVisibleService", void 0);
    __decorate([
        context_1.Optional('contextMenuFactory'),
        __metadata("design:type", Object)
    ], ListPanel.prototype, "contextMenuFactory", void 0);
    __decorate([
        context_1.Autowired('frameworkFactory'),
        __metadata("design:type", Object)
    ], ListPanel.prototype, "frameworkFactory", void 0);
    __decorate([
        __param(0, context_1.Qualifier('loggerFactory')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [logger_1.LoggerFactory]),
        __metadata("design:returntype", void 0)
    ], ListPanel.prototype, "agWire", null);
    __decorate([
        context_1.PreDestroy,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], ListPanel.prototype, "destroy", null);
    __decorate([
        context_1.PostConstruct,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], ListPanel.prototype, "init", null);
    ListPanel = __decorate([
        context_1.Bean('listPanel')
    ], ListPanel);
    return ListPanel;
}(beanStub_1.BeanStub));
